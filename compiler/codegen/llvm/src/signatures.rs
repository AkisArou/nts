...
pub const SIGNATURES: &[Signature] = &[
    ...
    Signature { name: "llvm.floor.f64", returns: "double", params: &["double"], attributes: &["nocallback", "nofree", "nosync", "nounwind", "willreturn", "memory(none)"] },
    ...
    Signature { name: "nts_alloc", returns: "ptr", params: &["i64"], attributes: &[] },
    ...
    Signature { name: "nts_array_new", returns: "ptr", params: &["ptr", "double"], attributes: &[] },
    Signature { name: "nts_array_new_uninitialized", returns: "ptr", params: &["ptr", "double"], attributes: &[] },
    ...
    Signature { name: "nts_concat", returns: "ptr", params: &["ptr", "ptr"], attributes: &[] },
    ...
    Signature { name: "nts_map_new", returns: "ptr", params: &["double"], attributes: &[] },
    ...
    Signature { name: "nts_object_new", returns: "ptr", params: &["ptr"], attributes: &[] },
    ...
    Signature { name: "nts_set_new", returns: "ptr", params: &["double"], attributes: &[] },
