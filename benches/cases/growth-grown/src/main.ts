...
//
// The hot loop below is character-for-character the one in `growth-fixed`. That
// is the point: a ratio between two programs that differ in the kernel would be
