...
import { BufferedReader } from "../node_modules/.tsbuild/host/runtime/web-platform/src/provider.js";
// Internal error types: a test may name them, but they are not widened into the
// provider boundary just to be asserted on.
import {
  LimitError,
  ProtocolError,
} from "../node_modules/.tsbuild/host/runtime/web-platform/src/core/errors.js";
import { readFrame } from "../node_modules/.tsbuild/host/runtime/web-platform/src/websocket/codec.js";
import { readHeaderFields } from "../node_modules/.tsbuild/host/runtime/web-platform/src/http1/parser.js";
