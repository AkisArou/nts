...
llvm_rc() { ( NTS_BACKEND=llvm NTS_RC=1; export NTS_BACKEND NTS_RC
  ...
  #
  # 266 -> 271 on 2026-09-19, one at a time, for `a-library-iterator-result`,
  # `a-narrowed-module-scope-global`, `a-table-built-from-an-array`,
  # `a-typed-array-from-an-array` and `a-method-used-as-a-value`.
  backend_examples 271 "through the LLVM backend, counting" "" 14 ); }
...
#
# 267 -> 272 on 2026-09-19, one at a time, for `a-library-iterator-result`,
# `a-narrowed-module-scope-global`, `a-table-built-from-an-array`,
# `a-typed-array-from-an-array` and `a-method-used-as-a-value`. The JVM's
# `exact` floor below took all five in the same runs and at the same numbers.
llvm() { ( NTS_BACKEND=llvm; export NTS_BACKEND
  backend_examples 272 "through the LLVM backend" "" 14 ); }
...
jvm() { ( NTS_BACKEND=jvm; export NTS_BACKEND
  ...
  backend_examples 272 "through the JVM backend" exact 10 ); }
corpus() {
