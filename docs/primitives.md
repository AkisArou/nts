...
|---|---|---|---|---|
| **number** | `arith`, `mathops`, `bitwise` | `number-to-string` 0 / 0 | `number-format` 0.86 / 0.51<br>`loop` 0.99 / 0.98<br>`fib` 1.71 / 0.52 | 0030, 0034, 0066 |
...
| **boolean, null, undefined** | `absent`, `nullish`, `unknown-truthiness` | `boolean-flags` 0 / 0 | `absences` 1.02 / 0.24 | 0031, 0039, 0053, 0057, 0069 |
| **bigint** | `bigint` | `bigint-arithmetic` 0 / 0 | `bigint` 0.99 / 0.09 | 0036, 0066 |
| **symbol** | `symbol-keys` | `symbol-keys` 0 / 0 | `symbol-keys` 1.02 / 0.19 | 0037, 0066 |
