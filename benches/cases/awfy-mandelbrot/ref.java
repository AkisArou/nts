// Are We Fast Yet's own `Mandelbrot`, unchanged, called the way `ref.cpp` calls
// their C++ one.
//
...
final class Ref extends Bench.Work {
    ...
    private static volatile double iterations = 500;

    @Override public double run() {
        return new Mandelbrot().innerBenchmarkLoop((int) iterations) ? 1 : 0;
    }
}
