...
public final class NtsViewI16 extends NtsView {
    ...
    /**
     * A Java {@code short[]} copied into a view of its own.
     *
     ...
     * A Java {@code short[]} is none of those things -- it has no buffer, no
     ...
     */
    public static NtsViewI16 from(short[] xs) {
        if (xs == null) { return of(0); }
        NtsViewI16 view = of(xs.length);
