...
|---|---|
| `✅` table rows | 166 |
| naming an `examples/` directory | 134 |
| quoting a case count | 14 |
| doing **either** | 136 |
| doing **neither** | **30** |

Thirty-three rows were cited on 2026-09-15 and the count moved 62 → 30; a further four say in the row that no example exercises part of what they claim, which leaves 28 silent. The table
