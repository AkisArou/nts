...
expected="clicked 0! clicked 0!! type Nts_Counter count 2 seen 0|0! plain p hello ada from hi ada greeter Nts_Greeter measure 42 17 square Nts_Square shy 1 true A 2 B 11 2 C 101 11 2 A 3 B 12 3 C 102 12 3 Nts_C 3 12 102 Q 6 R S 8 is C100|B|label|button|none "
