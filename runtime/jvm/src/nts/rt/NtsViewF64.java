...
public final class NtsViewF64 extends NtsView {
    ...
    /**
     * A Java {@code double[]} copied into a view of its own.
     *
     ...
     * A Java {@code double[]} is none of those things -- it has no buffer, no
     ...
     */
    public static NtsViewF64 from(double[] xs) {
        if (xs == null) { return of(0); }
        NtsViewF64 view = of(xs.length);
