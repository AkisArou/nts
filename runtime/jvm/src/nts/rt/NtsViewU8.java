...
public final class NtsViewU8 extends NtsView {
    ...
    /**
     * A Java {@code byte[]} copied into a view of its own.
     *
     ...
     * A Java {@code byte[]} is none of those things -- it has no buffer, no
     ...
     */
    public static NtsViewU8 from(byte[] xs) {
        if (xs == null) { return of(0); }
        NtsViewU8 view = of(xs.length);
