...
public final class NtsViewI64 extends NtsView {
     ...
     */
    public static NtsViewI64 create(NtsBuffer buffer, double byteOffset, double length,
    ...
    public static void set(NtsViewI64 view, NtsViewI64 source, double offset) {
