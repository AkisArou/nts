...
import {
  ...
  headersRawEntries,
} from "../../../../runtime/web-platform/src/fetch/headers.ts";
import { encodeMultipart } from "../../../../runtime/web-platform/src/forms/multipart.ts";
import { _createBlobFromExternalSource } from "../../../../runtime/web-platform/src/file/blob.ts";
import {
  bytesStream,
  tee,
  transfer,
} from "../../../../runtime/web-platform/src/streams/readable.ts";
...
import {
  ...
  parseChunkSize,
  readHead,
} from "../../../../runtime/web-platform/src/http1/parser.ts";
import {
  toClampedUnsignedShort,
  toUSVString,
} from "../../../../runtime/web-platform/src/core/webidl.ts";
import {
  closePayload,
  encodeFrame,
  ...
  parseClose,
  readFrame,
} from "../../../../runtime/web-platform/src/websocket/codec.ts";
import { websocketAccept } from "../../../../runtime/web-platform/src/websocket/handshake.ts";
import { negotiatePerMessageDeflate } from "../../../../runtime/web-platform/src/websocket/permessage-deflate.ts";
...
// so a test reaches them the same way the runtime does.
import { kStreamDisturbed } from "../../../../runtime/web-platform/src/streams/readable.ts";
