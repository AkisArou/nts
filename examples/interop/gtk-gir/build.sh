...
echo "log: $log"
expected="ymd=2026-9 keyfile true 5 no-error error-set 0 thrown split=a|b|c sha256=ba7816bf made press false buffer ab true cast-ok cast-null clicked 1 order=ab idle label=tick 3 status=0 ticks=3 kind=2 made=true again=rejected removed=true "
