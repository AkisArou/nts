...
|---|---|---|---|---|
| **number** | `arith`, `mathops`, `bitwise` | `number-to-string` 0 / 0 | `number-format` 0.82 / 0.49<br>`loop` 0.99 / 0.98<br>`fib` 1.71 / 0.52 | 0030, 0034, 0066 |
...
| **function and closure** | `closures`, `function-values` | `closure-capture` 0 / 0 | `closures` 1.01 / 0.38<br>`dispatch` 0.99 / 0.67 | 0040, 0066 |
