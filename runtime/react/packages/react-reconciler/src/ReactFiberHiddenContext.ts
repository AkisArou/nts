...
import { getEntangledRenderLanes, setEntangledRenderLanes } from "./ReactFiberWorkLoop.ts";
import { NoLanes, mergeLanes } from "./ReactFiberLane.ts";
...
export const currentTreeHiddenStackCursor: StackCursor<HiddenContext | null> = createCursor<HiddenContext | null>(null);
export const prevEntangledRenderLanesCursor: StackCursor<Lanes> = createCursor<Lanes>(NoLanes);
