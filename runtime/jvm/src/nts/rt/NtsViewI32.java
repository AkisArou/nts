...
public final class NtsViewI32 extends NtsView {
    ...
    /**
     * A Java {@code int[]} copied into a view of its own.
     *
     ...
     * A Java {@code int[]} is none of those things -- it has no buffer, no
     ...
     */
    public static NtsViewI32 from(int[] xs) {
        if (xs == null) { return of(0); }
        NtsViewI32 view = of(xs.length);
