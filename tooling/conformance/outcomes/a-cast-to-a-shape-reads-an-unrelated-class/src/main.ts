...
// confirmed independently by the compiler lane, whose probe this adapts; the fix,
// a checked unerase in `coerce`, is the React lane's. On the day it lands this
// flips to FIXED or to a named refusal -- either is right, a wrong length is not.
class Unrelated {
  first = 11;
  second = 22;
