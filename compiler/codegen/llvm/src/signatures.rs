...
pub const SIGNATURES: &[Signature] = &[
    ...
    Signature { name: "nts_array_push_value", returns: "double", params: &["ptr", "i32", "i64"], attributes: &[] },
    ...
    Signature { name: "nts_no_arm_of", returns: "void", params: &["i32", "i64", "ptr"], attributes: &["noreturn"] },
...
pub fn table(platform: crate::Platform) -> &'static [Signature] {
    match (platform.abi, platform.arch) {
        ...
        (nts_core::hir::native::NativeAbi::Win64, crate::Arch::X86_64) => super::signatures_win64::SIGNATURES_WIN64,
