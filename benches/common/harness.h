 ...
 * nts-generated, hand-written C, hand-written C with native integers -- is
 * measured by identical code. A per-variant timing loop would be a per-variant
 * opportunity to measure something slightly different.
 */
