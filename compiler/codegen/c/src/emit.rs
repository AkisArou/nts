...
fn unary_text(func: &Func, name: &str, un: UnOp, operand: ValueId) -> String {
    match un {
...
fn emit_op(writer: &mut CodeWriter, func: &Func, value: ValueId) -> Result<(), Diagnostic> {
    ...
    let text = match &op.kind {
        ...
        OpKind::Unary { op: un, operand } => unary_text(func, &name, *un, *operand),
