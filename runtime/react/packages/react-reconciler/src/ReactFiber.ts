...
import type { ActivityInstance, SuspenseInstance } from "./ReactFiberConfig.ts";
...
import { isHostHoistableType, isHostSingletonType, supportsResources, supportsSingletons } from "./ReactFiberConfig.ts";
