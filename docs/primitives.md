...
| **string** | `strings`, `string-methods` | `string-append` 1 / 2<br>`string-build` 1 / 2<br>`case-convert` 18 / 17 | `strings` 0.63 / 0.05<br>`node-utf8` — / 0.93<br>`substrings` 1.88 / 0.48<br>`case-convert` 0.40 / 0.83 | 0029, 0033, 0035, 0059 |
